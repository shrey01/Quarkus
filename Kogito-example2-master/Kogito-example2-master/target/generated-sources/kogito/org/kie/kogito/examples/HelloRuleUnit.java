...
public class HelloRuleUnit extends AbstractRuleUnit<Hello> {
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new org.kie.kogito.examples.Rules471B42E068A21F8D5BEF529A54AE3B27_Hello(), ruleBaseConfig);
        return kb;
    }
}
